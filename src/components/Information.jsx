  ...
  const Information=()=>{
    ...
    return(
       ...
       <div className="inf1">
        ...
        <br />
        <button className="b1" onClick={hire_me}>Hire me</button> <button className="b2"><a href="https://kesare.s3.ap-south-1.amazonaws.com/Boda+Balaji_Res.pdf">Resume</a></button>
               </div>
             <div className="inf2">
            <div >
